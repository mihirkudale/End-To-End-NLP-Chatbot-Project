...
def handle_eligibiliy_age(parameters: dict):
    ...
    if age>30:
        answer = random.choice([
            ...
            at the age of 51 and his past background was physical therapist.
            ...
            analyst working in a healthcare company.
...
def handle_eligibility_background(parameters: dict):
    ...
    if background:
        if background == "Mechanical Engineer":
            answer = '''I know many Mechanical Engineers who have successfully become data analysts. 
            ...
            is possible for sure.If they can do it, you can do it too. 
            '''
        if course_name:
            answer += " And yes you are eligible for " + "".join(course_name)
    else:
